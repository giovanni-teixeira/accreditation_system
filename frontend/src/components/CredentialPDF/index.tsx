...
const CredentialPDF = forwardRef<HTMLDivElement, CredentialPDFProps>(({ userData, corTipo }, ref) => {
    ...
    const qrSource = (userData as any).qrBase64 || `https://api.qrserver.com/v1/create-qr-code/?size=140x140&ecc=L&data=${encodeURIComponent(userData.qrToken)}&format=png&qzone=1`;
